...
import { G2InteractionType } from '@co/chart/core';
import { CoConfigService, InputBoolean, InputNumber } from '@co/core';
...
export class G2PieComponent implements OnInit, OnDestroy, OnChanges {
  ...
  constructor(public el: ElementRef<HTMLElement>, private ngZone: NgZone, private cdr: ChangeDetectorRef, configSrv: CoConfigService) {
