...
import { G2Time } from '@co/chart/core';
import { CoConfigService, deprecation10, InputBoolean, InputNumber, toDate } from '@co/core';
...
export class G2TimelineComponent implements OnInit, OnDestroy, OnChanges {
  ...
  constructor(private ngZone: NgZone, configSrv: CoConfigService) {
