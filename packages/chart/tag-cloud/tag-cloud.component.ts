...
import { CoConfigService, deprecation10, InputNumber } from '@co/core';
...
export class G2TagCloudComponent implements OnDestroy, OnChanges, OnInit {
  ...
  constructor(private el: ElementRef<HTMLDivElement>, private ngZone: NgZone, configSrv: CoConfigService) {
