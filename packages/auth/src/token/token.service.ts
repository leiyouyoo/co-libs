...
export function DA_SERVICE_TOKEN_FACTORY(): ITokenService {
  return new TokenService(inject(CoConfigService), inject(DA_STORE_TOKEN));
}
...
export class TokenService implements ITokenService {
  ...
  private _options: CoAuthConfig;

  constructor(configSrv: CoConfigService, @Inject(DA_STORE_TOKEN) private store: IStore) {
