...
import { AlainThemeModule } from '../../../../theme/src/theme.module';
import { CoI18NService, CoI18NServiceFake, CO_I18N_TOKEN } from './i18n';

describe('theme: i18n', () => {
  const i18n = new CoI18NServiceFake();
  ...
  describe('[i18n pipe]', () => {
    ...
    let srv: CoI18NService;

    @Injectable()
    class MockI18NService extends CoI18NServiceFake {
      data: any = {};
      use(_lang: string) {
        this.data = {
          simple: 'a',
    ...
    function genModule() {
      ...
      srv = fixture.debugElement.injector.get(CO_I18N_TOKEN);
      srv.use('en');
