...
import { CoConfigService, CoThemeResponsiveConfig } from '@co/core';
...
export class ResponsiveService {
  private cog: CoThemeResponsiveConfig;
  constructor(cogSrv: CoConfigService) {
    this.cog = cogSrv.merge<CoThemeResponsiveConfig, 'themeResponsive'>('themeResponsive', {
      rules: {
        1: { xs: 24 },
        2: { xs: 24, sm: 12 },
        3: { xs: 24, sm: 12, md: 8 },
