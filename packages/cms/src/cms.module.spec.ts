...
import { CoCmsModule } from './cms.module';
...
@NgModule({
    imports: [CoCmsModule, RouterModule.forRoot([])]
})
class AppModule { }

@NgModule({
    imports: [CoCmsModule.forRoot([app1]), RouterModule.forRoot([])]
})
...
describe('NgxPlanetModule', () => {
    ...
    describe('basic', () => {
        ...
        it('should get NgxPlanetModule', () => {
            expect(TestBed.inject(CoCmsModule)).toBeTruthy();
        });
