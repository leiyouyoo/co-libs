 ...
 *
 * ```
 * addPackageToPackageJson(host, [ '＠delon/cbc＠^1.0.0' ])
 * addPackageToPackageJson(host, [ '＠delon/cbc＠^1.0.0' ], 'devDependencies')
 * ```
 */
 ...
 *
 * ```
 * addPackageToPackageJson(host, [ '＠delon/cbc' ])
 * addPackageToPackageJson(host, [ '＠delon/cbc' ], 'devDependencies')
 * ```
 */
