...
describe('NgAlainSchematic: application', () => {
  ...
  describe(``, () => {
    ...
    it(`should add @co to dependencies`, () => {
      const packageJson = JSON.parse(tree.readContent('package.json'));
      expect(packageJson.dependencies['@co/theme']).toBeDefined();
      expect(packageJson.dependencies['@co/cbc']).toBeDefined();
      expect(packageJson.dependencies['@co/core']).toBeDefined();
      expect(packageJson.dependencies['@co/acl']).toBeDefined();
      expect(packageJson.dependencies['@co/auth']).toBeDefined();
      expect(packageJson.dependencies['@co/cache']).toBeDefined();
      expect(packageJson.dependencies['@co/mock']).toBeDefined();
    });
