...
export class StartupService {
  ...
  zip(<% if (i18n) { %>
    ...
    // ACL: Set the permissions to full, https://www.cityocean.com/acl/getting-started
    this.aclService.setFull(true);
    // Menu data, https://www.cityocean.com/theme/menu
    this.menuService.add(res.menu);
    // Can be set page suffix title, https://www.cityocean.com/theme/title
