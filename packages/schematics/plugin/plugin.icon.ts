...
const WHITE_ICONS = [
  ...
  'UploadOutline',
  'UpOutline',
  // - @cottps://github.com/ng-alain/delon/blob/master/packages/theme/src/theme.module.ts#L33
  'BellOutline',
  'DeleteOutline',
  'PlusOutline',
  'InboxOutline',
...
* @see https://www.cityocean.com/cli/plugin#icon
*/
...
export function pluginIcon(options: PluginOptions): Rule {
  return (host: Tree, context: SchematicContext) => {
    ...
    console.log(`\n\n`);
    console.log(`生成成功，如果是首次运行，需要手动引用，参考：https://www.cityocean.com/theme/icon/zh`);
    console.log(`Finished, if it's first run, you need manually reference it, refer to: https://www.cityocean.com/theme/icon/en`);
    console.log(`\n\n`);
  };
}
