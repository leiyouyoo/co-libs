...
import { OrganizationUnitDto, UserInfo, IMPlatformContactGroupDto, ContactUserDto, OrganizationUnitUserDto, MoveOrganizationUnitInput, } from './platform.types';
...
export class OrganizationUnitService extends BaseApi {
    ...
    ): Observable<ListResultDto<IMPlatformContactGroupDto>> {
        return null as any
    }
