...
import { PreShipmentListDto,CreateOrUpdateShipmentInput,WarehousingDto,ChangeShipmentInvalidStatusInput,GetPostAgentCustomerListOutput,SetShipmentPostAgentCustomerInput,ShipmentDto,GetShipmentListInput,Expression, } from './fcm.types';
...
export class ShipmentService extends BaseApi {
  constructor(injector: Injector) {
    ...
    /**
     * @param url /FCM/Shipment/AppendingPredicateByInput
     *
     */

    @POST('appendingPredicateByInput')
    appendingPredicateByInput(
        @Payload
        _req:GetShipmentListInput
