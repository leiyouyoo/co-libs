...
import { CoCacheConfig, CoConfigService } from '@co/core';
...
export class CacheService implements OnDestroy {
  ...
  private cog: CoCacheConfig;

  constructor(cogSrv: CoConfigService, @Inject(DC_STORE_STORAGE_TOKEN) private store: ICacheStore, private http: HttpClient) {
    this.cog = cogSrv.merge<CoCacheConfig, 'cache'>('cache', {
      mode: 'promise',
      reName: '',
      prefix: '',
