import { CoConfigService, CoSFConfig } from '@co/core';
...
export class FormPropertyFactory {
  private options: CoSFConfig;
  constructor(private schemaValidatorFactory: SchemaValidatorFactory, cogSrv: CoConfigService) {
