...
import { CoConfigService, CoErrorCollectConfig, InputNumber } from '@co/core';
...
export class ErrorCollectComponent implements OnInit, OnDestroy {
  ...
  constructor(private el: ElementRef, private cdr: ChangeDetectorRef, @Inject(DOCUMENT) private doc: any, configSrv: CoConfigService) {
    configSrv.attach<CoErrorCollectConfig, 'errorCollect'>(this, 'errorCollect', { freq: 500, offsetTop: 65 + 64 + 8 * 2 });
  }
