...
@Component({
  selector: 'data-dictionary-picker',
  exportAs: 'dataDictionaryPicker',
  providers: [
    {
  ...
  templateUrl: './data-dictionary-picker.component.html',
  host: {
    '[class.co-data-dictionary-picker]': 'true',
  },
})
export class DataDictionaryPickerComponent implements OnInit, ControlValueAccessor {
  data: any[];
  value: any | any[];
