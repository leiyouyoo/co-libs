...
import { CoConfigService, CoLodopConfig, LazyService } from '@co/core';
...
export class LodopService implements OnDestroy {
  private defaultConfig: CoLodopConfig;
  private _cog: CoLodopConfig;
  ...
  constructor(private scriptSrv: LazyService, configSrv: CoConfigService) {
    this.defaultConfig = configSrv.merge<CoLodopConfig, 'lodop'>('lodop', {
