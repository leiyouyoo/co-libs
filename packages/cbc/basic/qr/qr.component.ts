...
import { CoConfigService, CoQRConfig, InputNumber, LazyService } from '@co/core';
...
export class QRComponent implements OnChanges, AfterViewInit, OnDestroy {
  ...
  constructor(private cdr: ChangeDetectorRef, configSrv: CoConfigService, private lazySrv: LazyService) {
    this.cog = configSrv.merge<CoQRConfig, 'qr'>('qr', QR_DEFULAT_CONFIG);
