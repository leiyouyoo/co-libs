...
const wrapCls = `co-full-content__body`;
const openedCls = `co-full-content__opened`;
const hideTitleCls = `co-full-content__hidden-title`;

@Component({
  selector: 'co-full-content',
  exportAs: 'coFullContent',
  template: ` <ng-content></ng-content> `,
  host: {
    '[class.co-full-content]': 'true',
