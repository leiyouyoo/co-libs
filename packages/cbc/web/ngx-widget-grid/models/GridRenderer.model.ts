...
export class GridRenderer {
  ...
  public cachedNextPosition: Rectangle | undefined;
  public obstructions: (string | null)[] = [];
  public _grid: Grid;
  ...
  getNextPosition(): Rectangle | null {
    ...
    const maxPosition: Rectangle | null = this.findLargestEmptyArea();
    this.cachedNextPosition = maxPosition as any;
    return maxPosition;
  }
  ...
  setObstructionValues(area: Rectangle, value: string | null) {
  ...
  findLargestEmptyArea(): Rectangle | null {
    let maxArea: Rectangle | null = null;
    let currMaxArea: Rectangle | null = null;
