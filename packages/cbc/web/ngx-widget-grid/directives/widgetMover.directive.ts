...
export class NgxWidgetMoverDirective {
  ...
  public enableDrag: string | null = null;
  ...
  onDown(event: MouseEvent) {
    if (event.button === 0) {
      ...
      this.moverOffset = new Rectangle({
                                         top: eventOffsetY + this.el.nativeElement.offsetTop - window.pageYOffset || 0,
                                         left: eventOffsetX + this.el.nativeElement.offsetLeft - window.pageXOffset || 0
                                       });
