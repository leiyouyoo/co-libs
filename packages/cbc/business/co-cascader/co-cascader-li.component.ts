...
import { CoCascaderOption } from './typings';

@Component({
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None,
  selector: '[co-cascader-option]',
  exportAs: 'coCascaderOption',
  template: `
...
export class CoCascaderOptionComponent {
  @Input() optionTemplate: TemplateRef<CoCascaderOption> | null = null;
  @Input() option!: CoCascaderOption;
