...
import { CoConfigService, CoUtilArrayConfig } from '../config';
...
export class ArrayService {
  private c: CoUtilArrayConfig;
  constructor(cog: CoConfigService) {
    this.c = cog.merge<CoUtilArrayConfig, 'utilArray'>('utilArray', {
      deepMapName: 'deep',
