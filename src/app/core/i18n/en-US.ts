export const ENUS = {
  ...
  'app.header.menu.components': '@co/cbc',
  'app.header.menu.delon': 'Common Library',
  'app.header.menu.auth': '@co/auth-Authentication',
  'app.header.menu.acl': '@co/acl-Access Control List',
  'app.header.menu.cache': '@co/cache-Cache',
  'app.header.menu.chart': '@co/chart-Chart',
  'app.header.menu.mock': '@co/mock-Mock',
  'app.header.menu.util': '@co/core-Utils',
  'app.header.menu.form': '@co/form-Dynamic Form',
  'app.header.menu.theme': '@co/theme-Theme System',
