export const ZHCN = {
  ...
  'app.header.menu.components': '@co/cbc-标准组件',
  'app.header.menu.delon': '公共库',
  'app.header.menu.auth': '@co/auth-用户认证',
  'app.header.menu.acl': '@co/acl-访问控制列表',
  'app.header.menu.cache': '@co/cache-缓存',
  'app.header.menu.chart': '@co/chart-图表',
  'app.header.menu.mock': '@co/mock-Mock模拟数据',
  'app.header.menu.common': '@co/common-公共服务',
  'app.header.menu.core': '@co/core-核心库',
  'app.header.menu.form': '@co/form-动态表单',
  'app.header.menu.theme': '@co/theme-主题系统',
  'app.header.menu.im': '@co/im-即时消息',
  'app.header.menu.map': '@co/map-地图',
  'app.header.menu.apm': '@co/apm-应用性能监控',
