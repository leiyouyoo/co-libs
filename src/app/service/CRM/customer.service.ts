...
import { CustomerDto, CustomerListDto, MergeCustomerListInput, GetCustomerAllForUiPickerInput, ExternalPartnerAndCustomerDto, SearchCustomerOutput, CustomerOutput, CreateOrUpdateCustomerInput, GetCustomerByNameInput, CheckDeleteOutput, FollowCustomerInput, AssignCustomerInput, CustomerAndPartnerListDto, CustomerAuthenticateDto, AuditCustomerInput, MergeCustomerInput, } from './CRM.types';
