...
import { CoChartConfig, CoConfigService } from '@co/core';
...
export class ThemeBtnComponent implements OnInit {
  ...
  constructor(private appService: AppService, private renderer: Renderer2, private configSrv: CoConfigService) { }
  ...
  private updateChartTheme(): void {
    this.configSrv.update<CoChartConfig, 'chart'>('chart', { theme: this.theme === 'dark' ? 'dark' : '' });
  }
