...
rm -rf ${buildDir}
mkdir -p ${buildDir}
cp -r ${DIST}/@co ${buildDir}/@co
cp -r ${DIST}/co-plugin ${buildDir}/co-plugin
...
repoUrl="https://github.com/co-plugin/${packageRepo}.git"
...
echo "Download link:"
echo "https://github.com/co-plugin/delon-builds/archive/${buildTagName}.zip"
